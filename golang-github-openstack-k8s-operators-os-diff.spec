...
# Remove patch once https://github.com/openstack-k8s-operators/os-diff/pull/43 is merged
Patch002:               0001-Use-fully-qualified-name.patch
...
%prep
%goprep -k
# TODO(jcapitao): to remove once patches are merged
%autopatch -p1
